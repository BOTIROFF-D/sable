...
const CASE_LIST: Case[] = [
  ...
  {
    name: 'словарь из коротких пар тоже заполняет строки',
    input: 'let m = {аа: 1, бб: 2, вв: 3, гг: 4, дд: 5, ее: 6, жж: 7, зз: 8, ии: 9, кк: 10, лл: 11, '
      + 'мм: 12, нн: 13, оо: 14, пп: 15}\n',
    expect: 'let m = {\n  аа: 1, бб: 2, вв: 3, гг: 4, дд: 5, ее: 6, жж: 7, зз: 8, ии: 9, кк: 10, лл: 11,'
      + ' мм: 12, нн: 13,\n  оо: 14, пп: 15,\n}\n',
  },
  {
    name: 'словарь с длинными значениями идёт по паре на строку',
    input: 'let m = {первый: "очень длинное значение номер один", второй: "очень длинное значение номер два", '
      + 'третий: "очень длинное значение номер три"}\n',
    expect: 'let m = {\n  первый: "очень длинное значение номер один",\n'
      + '  второй: "очень длинное значение номер два",\n'
      + '  третий: "очень длинное значение номер три",\n}\n',
  },
  {
