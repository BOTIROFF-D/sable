...
print(площадь(1, 2, 3))`,
    expect: [
      { severity: 'error', line: 2, col: 14, match: '«площадь» ожидает от 1 до 2 аргумента, а получает 0' },
      { severity: 'error', line: 3, col: 14, match: '«площадь» ожидает от 1 до 2 аргумента, а получает 3' },
    ],
  },
  {
...
print(Точка(1, 2, 3))`,
    expect: [{ severity: 'error', line: 2, col: 12, match: '«Точка» ожидает от 0 до 2 аргумента, а получает 3' }],
  },
  {
